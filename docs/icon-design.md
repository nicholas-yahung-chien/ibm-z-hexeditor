...
The current icon is a working project asset for the MVP and can be replaced by a formal product-team design later.
...
- IBM Design Language iconography guidance for grid, contrast, simplified linework, and restrained color.
- IBM Z Open Editor and IBM Z Open Debug Marketplace icon family treatment.
