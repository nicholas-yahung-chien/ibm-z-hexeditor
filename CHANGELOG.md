...
- IBM-937 preview support.
- IBM-937 SO/SI diagnostics for explicit DBCS mode, missing or unmatched shift bytes, and conservative DBCS ambiguity warnings.
...
- Save confirmation when IBM-937 structural diagnostics report blocking DBCS issues.
...
- Local files only.
- IBM-937 has the most complete diagnostics.
